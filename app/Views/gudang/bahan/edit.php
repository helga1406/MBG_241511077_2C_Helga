...
<div class="container mt-5">
    <div class="card shadow-lg border-0">
        ...
        <div class="card-body">
            <form action="<?= base_url('gudang/bahan/update/'.$bahan['id']) ?>" method="post" 
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tanggal_masuk" name="tanggal_masuk" 
                           value="<?= $bahan['tanggal_masuk'] ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa" 
                           value="<?= $bahan['tanggal_kadaluarsa'] ?>" required>
                    <div class="invalid-feedback">Tanggal kadaluarsa wajib diisi.</div>
                </div>

                <button type="submit" class="btn btn-warning shadow-sm">Update</button>
